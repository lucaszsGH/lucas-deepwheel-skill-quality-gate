...
- Installation metadata reconciliation: PASS. Installer-owned `.installed-version` metadata is ignored while real Skill-file differences still return `INSTALL OUTDATED`.
